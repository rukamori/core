...
interface MusicBackend {
    ...
    suspend fun addToPlaylist(playlistId: String, videoId: String): Result<String>
    ...
    suspend fun playlistEntrySetVideoIds(playlistId: String, videoId: String): Result<List<String>>
    suspend fun removeFromPlaylist(playlistId: String, videoId: String, setVideoId: String): Result<Unit>
    suspend fun moveSongPlaylist(playlistId: String, setVideoId: String, successorSetVideoId: String?): Result<Unit>
